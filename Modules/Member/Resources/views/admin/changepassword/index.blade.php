...
<div class="row justify-content-center">
    <div class="col-4">
        ...
        <form action="{{ route('admin.member.change-password.update', $member->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            {{ method_field('PUT') }}    
            <div class="tile">
                <h3 class="tile-title">เปลี่ยนรหัสผ่าน #{{ $member->username }}</h3>
                <div class="tile-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-row">
