...
class MemberController extends BaseMemberManageController
{
    ...
    public function index($id, $info_id)
    {
        ...
        return $this->render('household::member.info.member.index', $data);
    }
    ...
    public function step1($id, $info_id, $member_id)
    {
        ...
        return $this->render('household::member.info.member.step1', $data);
    }
    ...
    public function step1Save(HouseholdMemberGeneralRequest $request, $id, $info_id, $member_id)
    {
       ...
       $result = $this->generalRepository->create($request->all());
        ...
        return redirect()->route('member.household.info.member.step2', [$id, $info_id, $member_id]);
    }
    ...
    public function step2($id, $info_id, $member_id)
    {
        ...
        return $this->render('household::member.info.member.step2', $data);
    }
    ...
    public function edit($store, $info, $id)
    {
        ...
        return $this->render('household::member.info.member.edit', $data);
    }
    ...
    public function update(HouseholdMemberRequest $request, $store, $info, $id)
    {
        ...
        return redirect()->route('member.household.info.member.index', [$store, $info]);
    }
...
// dd($data['result']);
        return $this->render('household::member.info.member.step1_edit', $data);
    ...
    public function step2edit($store, $info, $member, $id)
    {
        ...
        return $this->render('household::member.info.member.step2_edit', $data);
    }
