...
class EconController extends BaseManageController
{
    ...
    public function create($id, $info_id)
    {
        ...
        return $this->render('household::admin.info.econ.create', $data);
    }
    ...
    public function store(HouseholdEconRequest $request, $id, $info_id)
    {
       ...
       $this->repository->create($request->all());
        ...
        return redirect()->route('admin.household.info.enviro.create', [$id, $info_id]);
    }
    ...
    public function edit($store, $info, $id)
    {
        ...
        // dd($data['result']);
        return $this->render('household::admin.info.econ.create_edit', $data);
    }
    ...
    public function update(HouseholdEconRequest $request, $store, $info, $id)
    {
        ...
        // return redirect()->route('admin.household.info.econ.edit', [$store, $info, $result->id]);
    }
}
