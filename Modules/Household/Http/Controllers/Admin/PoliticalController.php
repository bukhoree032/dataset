...
class PoliticalController extends BaseManageController
{
    ...
    public function create($id, $info_id)
    {
        ...
        return $this->render('household::admin.info.political.create', $data);
    }
    ...
    public function store(HouseholdPoliticalRequest $request, $id, $info_id)
    {
        ...
        return redirect()->route('admin.household.info.communicat.create', [$id, $info_id]);
    }
    ...
    public function edit($store, $info, $id)
    {
        ...
        return $this->render('household::admin.info.political.edit', $data);
    }
