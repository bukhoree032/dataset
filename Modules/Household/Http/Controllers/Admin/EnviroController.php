...
class EnviroController extends BaseManageController
{
    ...
    public function create($id, $info_id)
    {
        ...
        return $this->render('household::admin.info.enviro.create', $data);
    }
    ...
    public function store(HouseholdEnviroRequest $request, $id, $info_id)
    {
        ...
        return redirect()->route('admin.household.info.political.create', [$id, $info_id]);
    }
    ...
    public function edit($store, $info, $id)
    {
        ...
        return $this->render('household::admin.info.enviro.edit', $data);
    }
    ...
    public function update(HouseholdEnviroRequest $request, $store, $info, $id)
    {
        ...
        // return redirect()->route('admin.household.info.enviro.edit', [$store, $info, $result->id]);
    }
}
