...
use Modules\Household\Entities\HouseholdPolitical;

class HouseholdPoliticalRepository extends BaseRepository
{
    public function __construct()
    {
        $this->init([
            'class_model_name' => HouseholdPolitical::class
        ]);
    }
    ...
    public function get($id)
    {
        ...
        $result->HOUSEHOLD_POLITICAL_COM_ELEC_NUM = unserialize($result->HOUSEHOLD_POLITICAL_COM_ELEC_NUM);
