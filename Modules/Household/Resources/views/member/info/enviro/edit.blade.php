...
<div class="row justify-content-center">
    <div class="col-sm-12 col-md-8">
        ...
        <form action="{{ route('member.household.info.enviro.update',[request()->store, $result->household_info_id,  $result->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            {{ method_field('PUT') }}
            <div class="tile">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="dropdown-check-list form-control" tabindex="100">
                                ...
                                <ul class="items">
                                    ...
                                    <li>
                                        <input type="checkbox" name="HOUSEHOLD_ENVIR_WLIGHT[{{ $index }}]" class="input-WLIGHT_" data-label="{{ $value['label'] }}" value="{{ $value['label'] }}" @if(isset($result->HOUSEHOLD_ENVIR_WLIGHT[$index]) && ($result->HOUSEHOLD_ENVIR_WLIGHT[$index] == $value['label'])) checked @endif/>
                                        {{ $value['label'] }}
                                    </li>
                                    @endforeach
                                </ul>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="dropdown-check-list form-control" tabindex="100">
                                ...
                                <ul class="items">
                                    ...
                                    <li>
                                        <input type="checkbox" name="HOUSEHOLD_ENVIR_CLEAN[{{ $index }}]" class="input-CLEAN_" data-label="{{ $value['label'] }}" value="{{ $value['label'] }}" @if(isset($result->HOUSEHOLD_ENVIR_CLEAN[$index]) && ($result->HOUSEHOLD_ENVIR_CLEAN[$index] == $value['label'])) checked @endif/>
                                        {{ $value['label'] }}
                                    </li>
                                    @endforeach
                                </ul>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="dropdown-check-list form-control" tabindex="100">
                                ...
                                <ul class="items">
                                    ...
                                    <li>
                                        <input type="checkbox" name="HOUSEHOLD_ENVIR_SAFE[{{ $index }}]" class="input-SAFE_" data-label="{{ $value['label'] }}" value="{{ $value['label'] }}" @if(isset($result->HOUSEHOLD_ENVIR_SAFE[$index]) && ($result->HOUSEHOLD_ENVIR_SAFE[$index] == $value['label'])) checked @endif/>
                                        {{ $value['label'] }}
                                    </li>
                                    @endforeach
                                </ul>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="dropdown-check-list form-control" tabindex="100">
                                ...
                                <ul class="items">
                                    ...
                                    <li>
                                        <input type="checkbox" name="HOUSEHOLD_ENVIR_BIN[{{ $index }}]" class="input-BIN_" data-label="{{ $value['label'] }}" value="{{ $value['label'] }}" @if(isset($result->HOUSEHOLD_ENVIR_BIN[$index]) && ($result->HOUSEHOLD_ENVIR_BIN[$index] == $value['label'])) checked @endif/>
                                        {{ $value['label'] }}
                                    </li>
                                    @endforeach
                                </ul>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="dropdown-check-list form-control" tabindex="100">
                                ...
                                <ul class="items">
                                    ...
                                    <li>
                                        <input type="checkbox" name="HOUSEHOLD_ENVIR_H_ENVI[{{ $index }}]" class="input-H_ENVI_" data-label="{{ $value['label'] }}" value="{{ $value['label'] }}" @if(isset($result->HOUSEHOLD_ENVIR_H_ENVI[$index]) && ($result->HOUSEHOLD_ENVIR_H_ENVI[$index] == $value['label'])) checked @endif/>
                                        {{ $value['label'] }}
                                    </li>
                                    @endforeach
                                    <li>
                                        <textarea placeholder="กรณีอื่น" name="HOUSEHOLD_ENVIR_H_ENVI_OTHER">{{ $result->HOUSEHOLD_ENVIR_H_ENVI_OTHER }}</textarea>
                                    </li>
                                </ul>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="dropdown-check-list form-control" tabindex="100">
                                ...
                                <ul class="items">
                                    ...
                                    <li>
                                        <input type="checkbox" name="HOUSEHOLD_ENVIR_TOXIC[{{ $index }}]" class="input-TOXIC_" data-label="{{ $value['label'] }}" value="{{ $value['label'] }}" @if(isset($result->HOUSEHOLD_ENVIR_TOXIC[$index]) && ($result->HOUSEHOLD_ENVIR_TOXIC[$index] == $value['label'])) checked @endif/>
                                        {{ $value['label'] }}
                                    </li>
                                    @endforeach
                                </ul>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="dropdown-check-list form-control" tabindex="100">
                                ...
                                <ul class="items">
                                    ...
                                    <li>
                                        <input type="checkbox" name="HOUSEHOLD_ENVIR_WATER[{{ $index }}]" class="input-WATER_" data-label="{{ $value['label'] }}" value="{{ $value['label'] }}" @if(isset($result->HOUSEHOLD_ENVIR_WATER[$index]) && ($result->HOUSEHOLD_ENVIR_WATER[$index] == $value['id'])) checked @endif/>
                                        {{ $value['label'] }}
                                    </li>
                                    @endforeach
                                </ul>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="dropdown-check-list form-control" tabindex="100">
                                ...
                                <ul class="items">
                                    ...
                                    <li>
                                        <input type="checkbox" name="HOUSEHOLD_ENVIR_DRINKING[{{ $index }}]" class="input-DRINKING_" data-label="{{ $value['label'] }}" value="{{ $value['label'] }}" @if(isset($result->HOUSEHOLD_ENVIR_DRINKING[$index]) && ($result->HOUSEHOLD_ENVIR_DRINKING[$index] == $value['label'])) checked @endif/>
                                        {{ $value['label'] }}
                                    </li>
                                    @endforeach
                                </ul>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="dropdown-check-list form-control" tabindex="100">
                                ...
                                <ul class="items">
                                    ...
                                    <li>
                                        <input type="checkbox" name="HOUSEHOLD_ENVIR_CONTAINER[{{ $index }}]" class="input-CONTAINER" data-label="{{ $value['label'] }}" value="{{ $value['label'] }}" @if(isset($result->HOUSEHOLD_ENVIR_CONTAINER[$index]) && ($result->HOUSEHOLD_ENVIR_CONTAINER[$index] == $value['label'])) checked @endif/>
                                        {{ $value['label'] }}
                                    </li>
                                    @endforeach
                                </ul>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="dropdown-check-list form-control" tabindex="100">
                                ...
                                <ul class="items">
                                    ...
                                    <li>
                                        <input type="checkbox" name="HOUSEHOLD_ENVIR_COOKING[{{ $index }}]" class="input-COOKING_" data-label="{{ $value['label'] }}" value="{{ $value['label'] }}" @if(isset($result->HOUSEHOLD_ENVIR_COOKING[$index]) && ($result->HOUSEHOLD_ENVIR_COOKING[$index] == $value['label'])) checked @endif/>
                                        {{ $value['label'] }}
                                    </li>
                                    @endforeach
                                </ul>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="dropdown-check-list form-control" tabindex="100">
                                ...
                                <ul class="items">
                                    @foreach(__jobs4_7_1() as $index => $value)
                                    <li>
                                        <input type="checkbox" name="HOUSEHOLD_ENVIR_WATER_USED[{{ $index }}]" class="input-WATER_USED_" data-label="{{ $value['label'] }}" value="{{ $value['label'] }}" @if(isset($result->HOUSEHOLD_ENVIR_WATER_USED[$index]) && ($result->HOUSEHOLD_ENVIR_WATER_USED[$index] == $value['label'])) checked @endif/>
                                        {{ $value['label'] }}
                                    </li>
                                    @endforeach
                                </ul>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="dropdown-check-list  form-control" tabindex="100">
                                ...
                                <ul class="items">
                                    @foreach(__jobs4_7_2() as $index => $value)
                                    <li>
                                        <input type="checkbox" name="HOUSEHOLD_ENVIR_CONTAINER_USED[{{ $index }}]" class="input-CONTAINER_USED" data-label="{{ $value['label'] }}" value="{{ $value['label'] }}" @if(isset($result->HOUSEHOLD_ENVIR_CONTAINER_USED[$index]) && ($result->HOUSEHOLD_ENVIR_CONTAINER_USED[$index] == $value['label'])) checked @endif/>
                                        {{ $value['label'] }}
                                    </li>
                                    @endforeach
                                </ul>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="dropdown-check-list  form-control" tabindex="100">
                                ...
                                <ul class="items">
                                    @foreach(__jobs4_7_3() as $index => $value)
                                    <li>
                                        <input type="checkbox" name="HOUSEHOLD_ENVIR_AREA[{{ $index }}]" class="input-AREA_" data-label="{{ $value['label'] }}" value="{{ $value['label'] }}" @if(isset($result->HOUSEHOLD_ENVIR_AREA[$index]) && ($result->HOUSEHOLD_ENVIR_AREA[$index] == $value['label'])) checked @endif/>
                                        {{ $value['label'] }}
                                    </li>
                                    @endforeach
                                </ul>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="dropdown-check-list form-control" tabindex="100">
                                ...
                                <ul class="items">
                                    ...
                                    <li>
                                        <input type="checkbox" name="HOUSEHOLD_ENVIR_ENV_ACT[{{ $index }}]" class="input-ENV_ACT_" data-label="{{ $value['label'] }}" value="{{ $value['label'] }}" @if(isset($result->HOUSEHOLD_ENVIR_ENV_ACT[$index]) && ($result->HOUSEHOLD_ENVIR_ENV_ACT[$index] == $value['label'])) checked @endif/>
                                        {{ $value['label'] }}
                                    </li>
                                    @endforeach
                                    <li>
                                        <textarea placeholder="กรณีอื่น" name="HOUSEHOLD_ENVIR_ENV_ACT_OTHER">{{ $result->HOUSEHOLD_ENVIR_ENV_ACT_OTHER }}</textarea>
                                    </li>
                                </ul>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="dropdown-check-list form-control" tabindex="100">
                                ...
                                <ul class="items">
                                    ...
                                    <li>
                                        <input type="checkbox" name="HOUSEHOLD_ENVIR_ELECTRIC[{{ $index }}]" class="input-ELECTRIC_" data-label="{{ $value['label'] }}" value="{{ $value['label'] }}" @if(isset($result->HOUSEHOLD_ENVIR_ELECTRIC[$index]) && ($result->HOUSEHOLD_ENVIR_ELECTRIC[$index] == $value['label'])) checked @endif/>
                                        {{ $value['label'] }}
                                    </li>
                                    @endforeach
                                </ul>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="dropdown-check-list  form-control" tabindex="100">
                                ...
                                <ul class="items">
                                    ...
                                    <li>
                                        <input type="checkbox" name="HOUSEHOLD_ENVIR_CONSERV[{{ $index }}]" class="input-CONSERV_" data-label="{{ $value['label'] }}" value="{{ $value['label'] }}" @if(isset($result->HOUSEHOLD_ENVIR_CONSERV[$index]) && ($result->HOUSEHOLD_ENVIR_CONSERV[$index] == $value['label'])) checked @endif/>
                                        {{ $value['label'] }}
                                    </li>
                                    @endforeach
                                    <li>
                                        <textarea placeholder="กรณีอื่น" name="HOUSEHOLD_ENVIR_CONSERV_OTHER">{{ $result->HOUSEHOLD_ENVIR_CONSERV_OTHER }}</textarea>
                                    </li>
                                </ul>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="dropdown-check-list form-control" tabindex="100">
                                ...
                                <ul class="items">
                                    ...
                                    <li>
                                        <input type="checkbox" name="HOUSEHOLD_ENVIR_DISASTER[{{ $index }}]" class="input-DISASTER_" data-label="{{ $value['label'] }}" value="{{ $value['label'] }}" @if(isset($result->HOUSEHOLD_ENVIR_DISASTER[$index]) && ($result->HOUSEHOLD_ENVIR_DISASTER[$index] == $value['label'])) checked @endif/>
                                        {{ $value['label'] }}
                                    </li>
                                    @endforeach
                                    <li>
                                        <textarea placeholder="กรณีอื่น" name="HOUSEHOLD_ENVIR_AREA_OCCUP_OTHER">{{ $result->HOUSEHOLD_ENVIR_AREA_OCCUP_OTHER }}</textarea>
                                    </li>
                                </ul>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="dropdown-check-list form-control" tabindex="100">
                                ...
                                <ul class="items">
                                    ...
                                    <li>
                                        <input type="checkbox" name="HOUSEHOLD_ENVIR_SOLUTION[{{ $index }}]" class="input-SOLUTION_" data-label="{{ $value['label'] }}" value="{{ $value['label'] }}" @if(isset($result->HOUSEHOLD_ENVIR_SOLUTION[$index]) && ($result->HOUSEHOLD_ENVIR_SOLUTION[$index] == $value['label'])) checked @endif/>
                                        {{ $value['label'] }}
                                    </li>
                                    @endforeach
                                    <li>
                                        <textarea placeholder="กรณีอื่น" name="HOUSEHOLD_ENVIR_SOLUTION_OTHER">{{ $result->HOUSEHOLD_ENVIR_SOLUTION_OTHER }}</textarea>
                                    </li>
                                </ul>
