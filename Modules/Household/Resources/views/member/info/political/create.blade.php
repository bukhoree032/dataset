...
<div class="row justify-content-center">
    <div class="col-sm-12 col-md-8">
        ...
        <form action="{{ route('member.household.info.political.store',[$store_id, $info_id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="tile">
                                ...
                                <div class="dropdown-check-list form-control" tabindex="100">
                                    ...
                                    <ul class="items">
                                        ...
                                        <li>
                                            <div class="row">
                                                <div class="col-md-9">
                                                    <input type="checkbox" name="HOUSEHOLD_POLITICAL_COM_ELEC[{{ $index }}]" class="input-COM_ELEC_" data-label="{{ $value['label'] }}" value="{{ $value['label'] }}" @if(old("HOUSEHOLD_POLITICAL_COM_ELEC.$index")) checked @endif />
                                                    {{ $value['label'] }}
                                                </div>
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="text" name="HOUSEHOLD_POLITICAL_COM_ELEC_NUM[{{ $index }}]" style="width: 100%" placeholder="จำนวนสามชิกที่เข้าร่วม" value="{{ old("HOUSEHOLD_POLITICAL_COM_ELEC_NUM.$index") }}" />
                                                </div>
                                            </div>
                                        </li>
                                        @endforeach
                                        <li>
                                            <textarea placeholder="กรณีอื่น" name="HOUSEHOLD_POLITICAL_COM_ELEC_OTHER" value="{{ old('HOUSEHOLD_POLITICAL_COM_ELEC_OTHER') }}"></textarea>
                                        </li>
                                    </ul>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="dropdown-check-list form-control" tabindex="100">
                                        ...
                                        <ul class="items">
                                            ...
                                            <li>
                                                <input type="radio" name="HOUSEHOLD_POLITICAL_HH_CONFLICT" class="input-HH_CONFLICT" data-label="{{ $value['label'] }}" value="{{ $value['label'] }}" @if(old("HOUSEHOLD_POLITICAL_HH_CONFLICT")) checked @endif />
                                                {{ $value['label'] }}
                                            </li>
                                            @endforeach
                                        </ul>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="dropdown-check-list form-control" tabindex="100">
                                        ...
                                        <ul class="items">
                                            @foreach(__jobs5_2() as $index => $value)
                                            <li>
                                                <input type="radio" name="HOUSEHOLD_POLITICAL_CONFLICT_OTHER" class="input-CONFLICT_OTHER" data-label="{{ $value['label'] }}" value="{{ $value['label'] }}" @if(old("HOUSEHOLD_POLITICAL_CONFLICT_OTHER")) checked @endif />
                                                {{ $value['label'] }}
                                            </li>
                                            @endforeach
                                        </ul>
