    ...
    <div class="form-group col-md-6">
        ...
        <div class="dropdown-check-list form-control" tabindex="100">
            ...
            <ul class="items">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <input type="checkbox" name="HOUSEHOLD_ECON_HOUSE_LIST[{{ $index }}]" class="input-HOUSE_LIST" data-label="{{ $value['label'] }}" value="{{ $value['label'] }}" @if(isset($result->HOUSEHOLD_ECON_HOUSE_LIST[$index]) && ($result->HOUSEHOLD_ECON_HOUSE_LIST[$index] == $value['id'] || $result->HOUSEHOLD_ECON_HOUSE_LIST[$index] == $value['label'])) checked @endif/>
                        {{ $value['label'] }}
                    </div>
                    <div class="col-md-6">
        ...
        <div class="dropdown-check-list form-control" tabindex="100">
            ...
            <ul class="items">
                ...
                <li>
                    <div class="row">
                        <div class="col-md-6">
                            <input type="checkbox" name="HOUSEHOLD_ECON_LAND[{{ $index }}]" class="input-LAND" data-label="{{ $value['label'] }}" value="{{ $value['label'] }}" @if(isset($result->HOUSEHOLD_ECON_LAND[$index]) && ($result->HOUSEHOLD_ECON_LAND[$index] == $value['id'] || $result->HOUSEHOLD_ECON_LAND[$index] == $value['label'])) checked @endif/>
                            {{ $value['label'] }}
                        </div>
                        <div class="col-md-6">
