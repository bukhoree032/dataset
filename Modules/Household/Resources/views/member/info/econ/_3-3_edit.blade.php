<div class="row">
    ...
    <div class="col-md-4">
        <label class="red-start">จำนวนเงิน</label> <input name="HOUSEHOLD_DEPT_AMOUNT" class="form-control @error('HOUSEHOLD_DEPT_AMOUNT') is-invalid @enderror" type="text" placeholder="ตัวอย่าง 50000" value="{{ $result->HOUSEHOLD_DEPT_AMOUNT }}" />
    ...
    <div class="form-group col-md-6">
        ...
        <div class="dropdown-check-list form-control" tabindex="100">
            ...
            <ul class="items">
                ...
                @if ($value['id']==8)
                <textarea placeholder="กรณีอื่น ๆ" name="HOUSEHOLD_ECON_COMM_BANK_OTHER[{{ $index }}]">{{ $result->HOUSEHOLD_ECON_COMM_BANK_OTHER[$index] }}</textarea>
                @else
                @endif
                @endforeach
        ...
        <div class="dropdown-check-list form-control" tabindex="100">
            ...
            <ul class="items">
                ...
                <li style="margin-top: 5px;">
                    ...
                    @endif
                    @if ($value['id']==3)
                    <textarea placeholder="กรณีอื่น ๆ" name="HOUSEHOLD_ECON_NONBANK_OTHER[{{ $index }}]">{{ $result->HOUSEHOLD_ECON_NONBANK_OTHER[$index] }}</textarea>
                    @else
                    @endif
    ...
    <div class="form-group col-md-6">
        ...
        <div class="dropdown-check-list form-control" tabindex="100">
            ...
            <ul class="items">
                ...
                @if ($value['id']==10)
                <textarea placeholder="กรณีอื่น ๆ" name="HOUSEHOLD_ECON_COMMU_FUND_OTHER[{{ $index }}]">{{ $result->HOUSEHOLD_ECON_COMMU_FUND_OTHER[$index] }}</textarea>
                @else
    ...
    <div class="form-group col-md-6">
        <div class="dropdown-check-list form-control" tabindex="100">
            ...
            <ul class="items">
                ...
                @if ($value['id']==15)
                <textarea placeholder="กรณีอื่น ๆ" name="HOUSEHOLD_ECON_H_SAVING_OTHER[{{ $index }}]">{{ $result->HOUSEHOLD_ECON_H_SAVING_OTHER[$index] }}</textarea>
                @else
    ...
    <div class="form-group col-md-6">
        ...
        <div class="dropdown-check-list form-control" tabindex="100">
            ...
            <ul class="items">
                ...
                @if ($value['id']==7)
                <textarea placeholder="กรณีอื่น ๆ" name="HOUSEHOLD_ECON_OCCUP_PROBLEM_OTHER[{{ $index }}]">{{ $result->HOUSEHOLD_ECON_OCCUP_PROBLEM_OTHER[$index] }}</textarea>
                @else
                @endif
                @endforeach
            </ul>
    ...
    <div class="form-group col-md-6">
        ...
        <div class="dropdown-check-list form-control" tabindex="100">
            ...
            <ul class="items">
                ...
                @if ($value['id']==5)
                <textarea placeholder="กรณีอื่น ๆ" name="HOUSEHOLD_ECON_LIVING_PROBLEM_OTHER[{{ $index }}]">{{ $result->HOUSEHOLD_ECON_LIVING_PROBLEM_OTHER[$index] }}</textarea>
                @else
                @endif
                @endforeach
