...
<div class="row justify-content-center">
    <div class="col-10">
        ...
        <form action="{{ route('member.household.info.member.step2-save',[$store_id, $info_id, $member_id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="tile">
                                              ...
                                              <div class="col-md-4 mb-3">
                                                 ...
                                                 <div class="dropdown-check-list" tabindex="100" style="width: 100%">
                                                    ...
                                                    <ul class="items" style="width: 100%">
                                                       ...
                                                       <li><input type="checkbox" name="HOUSEHOLD_MEMBER_HEALTH_RISK[{{ $index }}]" class="input-RISK" data-label="{{ $value['label'] }}"  value="{{ $value['label'] }}" @if(old("HOUSEHOLD_MEMBER_HEALTH_RISK.$index")) checked @endif/> {{ $value['label'] }}</li>
                                                       @endforeach
                                                    </ul>
                                              ...
                                              <div class="col-md-4 mb-3">
                                                 ...
                                                 <div class="dropdown-check-list" tabindex="100" style="width: 100%">
                                                    ...
                                                    <ul  class="items" style="width: 100%">
                                                       ...
                                                       <li><input type="checkbox" name="HOUSEHOLD_MEMBER_HEALTH_RISK_OCCUP[{{ $index }}]" class="input-RISK_OCCUP" data-label="{{ $value['label'] }}"  value="{{ $value['label'] }}" @if(old("HOUSEHOLD_MEMBER_HEALTH_RISK_OCCUP.$index")) checked @endif/> {{ $value['label'] }} </li>
                                                       @endforeach
                                                    </ul>
                                              ...
                                              <div class="col-md-4 mb-3">
                                                 ...
                                                 <div class="dropdown-check-list" tabindex="100" style="width: 100%">
                                                    ...
                                                    <ul class="items" style="width: 100%">
                                                       ...
                                                       <li><input type="checkbox" name="HOUSEHOLD_MEMBER_HEALTH_HCARE[{{ $index }}]" class="input-HCARE_" data-label="{{ $value['label'] }}"  value="{{ $value['label'] }}" @if(old("HOUSEHOLD_MEMBER_HEALTH_HCARE.$index")) checked @endif/> {{ $value['label'] }} </li>
                                                       @endforeach
                                                    </ul>
                                              ...
                                              <div class="col-md-4 mb-3">
                                                 ...
                                                 <div class="dropdown-check-list" tabindex="100" style="width: 100%">
                                                    ...
                                                    <ul class="items" style="width: 100%">
                                                       ...
                                                       <li><input type="checkbox" name="HOUSEHOLD_MEMBER_HEALTH_EMERGENCY[{{ $index }}]" class="input-EMERGENCY" data-label="{{ $value['label'] }}"  value="{{ $value['label'] }}" @if(old("HOUSEHOLD_MEMBER_HEALTH_EMERGENCY.$index")) checked @endif/> {{ $value['label'] }} </li>
                                                       @endforeach
                                                    </ul>
                                              ...
                                              <div class="col-md-4 mb-3">
                                                 ...
                                                 <div class="dropdown-check-list" tabindex="100" style="width: 100%">
                                                    ...
                                                    <ul class="items" style="width: 100%">
                                                       ...
                                                       <li><input type="checkbox" name="HOUSEHOLD_MEMBER_HEALTH_C_ILLNESS[{{ $index }}]" class="input-C_ILLNESS" data-label="{{ $value['label'] }}"  value="{{ $value['label'] }}" @if(old("HOUSEHOLD_MEMBER_HEALTH_C_ILLNESS.$index")) checked @endif/> {{ $value['label'] }} </li>
                                                       @endforeach
                                                       <textarea style="width: 100%" placeholder="กรณีอื่น ๆ" name="HOUSEHOLD_MEMBER_HEALTH_C_ILLNESS_OTHER"  value="{{ old('HOUSEHOLD_MEMBER_HEALTH_C_ILLNESS_OTHER') }}"></textarea>
                                                    </ul>
                                              ...
                                              <div class="col-md-4 mb-3">
                                                 ...
                                                 <div class="dropdown-check-list" tabindex="100" style="width: 100%">
                                                    ...
                                                    <ul class="items" style="width: 100%">
                                                       ...
                                                       <li>
                                                          <input type="checkbox" name="HOUSEHOLD_MEMBER_HEALTH_CARER_[{{ $index }}]" value="{{ $value['label'] }}" @if(old("HOUSEHOLD_MEMBER_HEALTH_CARER_.$index")) checked @endif/> {{ $value['label'] }}
                                                            @if ($value['id']==10) 
                                                          <input type="" name="HOUSEHOLD_MEMBER_HEALTH_CARER_OTHER[{{ $index }}]" value="{{ old('HOUSEHOLD_MEMBER_GENERAL_SKILL_OTHER') }}" placeholder="ระบุ กรณีตัวเลือกข้อ 10" style="width: 100%">
                                                            @endif
                                                            @if ($value['id']==11) 
                                                          <input type="" name="HOUSEHOLD_MEMBER_HEALTH_CARER_OTHER[{{ $index }}]" value="{{ old('HOUSEHOLD_MEMBER_GENERAL_SKILL_OTHER') }}" placeholder="ระบุ กรณีตัวเลือกข้อ 11" style="width: 100%">
                                                            @else
                                                            @endif
                                                       </li>
                                                       @endforeach
                                                       <textarea style="width: 100%" placeholder="กรณีอื่น ๆ" name="HOUSEHOLD_MEMBER_HEALTH_CARER_OTHER[{{ $index }}]" value="{{ old('HOUSEHOLD_MEMBER_HEALTH_CARER_OTHER') }}"></textarea>
                                                    </ul>
                                              ...
                                              <div class="col-md-4 mb-3">
                                                 ...
                                                 <div class="dropdown-check-list" tabindex="100" style="width: 100%">
                                                    ...
                                                    <ul class="items" style="width: 100%">
                                                       ...
                                                       <li><input type="radio" id="male{{ $value['id'] }}" name="HOUSEHOLD_MEMBER_HEALTH_W_CARE" class="input-W_CARE" data-label="{{ $value['label'] }}" value="{{ $value['label'] }}" @if(old("HOUSEHOLD_MEMBER_HEALTH_W_CARE")) checked @endif/> {{ $value['label'] }} </li>
                                                       @endforeach
                                                       <textarea style="width: 100%" placeholder="กรณีอื่น ๆ" name="HOUSEHOLD_MEMBER_HEALTH_W_CARE_OTHER" value="{{ old('HOUSEHOLD_MEMBER_HEALTH_W_CARE_OTHER') }}"></textarea>
                                                    </ul>
                                              ...
                                              <div class="col-md-4 mb-3">
                                                 ...
                                                 <div id="list2_8" class="dropdown-check-list" tabindex="100" style="width: 100%">
                                                    ...
                                                    <ul id="items2_8" class="items" style="width: 100%">
                                                       ...
                                                       <li><input type="checkbox" name="HOUSEHOLD_MEMBER_HEALTH_P_CARE[{{ $index }}]" class="input-P_CARE" data-label="{{ $value['label'] }}"  value="{{ $value['label'] }}" @if(old("HOUSEHOLD_MEMBER_HEALTH_P_CARE.$index")) checked @endif/> {{ $value['label'] }} </li>
                                                       @endforeach
                                                       <textarea style="width: 100%" placeholder="กรณีอื่น ๆ" name="HOUSEHOLD_MEMBER_HEALTH_P_CARE_OTHER" value="{{ old('HOUSEHOLD_MEMBER_HEALTH_P_CARE_OTHER') }}"></textarea>
                                                    </ul>
                                              ...
                                              <div class="col-md-4 mb-3">
                                                 ...
                                                 <div class="dropdown-check-list" tabindex="100" style="width: 100%">
                                                    ...
                                                    <ul class="items" style="width: 100%">
                                                       ...
                                                       <li><input type="checkbox" name="HOUSEHOLD_MEMBER_HEALTH_ILLNESS[{{ $index }}]" class="input-ILLNESS" data-label="{{ $value['label'] }}"  value="{{ $value['label'] }}" @if(old("HOUSEHOLD_MEMBER_HEALTH_ILLNESS.$index")) checked @endif/> {{ $value['label'] }} </li>
                                                       @endforeach
                                                    </ul>
                                              ...
                                              <div class="col-md-4 mb-3">
                                                 ...
                                                 <div class="dropdown-check-list" tabindex="100" style="width: 100%">
                                                    ...
                                                    <ul class="items" style="width: 100%">
                                                       ...
                                                       <li><input type="checkbox" name="HOUSEHOLD_MEMBER_HEALTH_BENEFIT[{{ $index }}]" class="input-BENEFIT" data-label="{{ $value['label'] }}"  value="{{ $value['label'] }}" @if(old("HOUSEHOLD_MEMBER_HEALTH_BENEFIT.$index")) checked @endif/> {{ $value['label'] }} </li>
                                                       @endforeach
                                                    </ul>
                                              ...
                                              <div class="col-md-4 mb-3">
                                                 ...
                                                 <div class="dropdown-check-list" tabindex="100" style="width: 100%">
                                                    ...
                                                    <ul class="items" style="width: 100%">
                                                       ...
                                                       <li><input type="checkbox" name="HOUSEHOLD_MEMBER_HEALTH_BENEFIT_TYPE[{{ $index }}]" class="input-BENEFIT_TYPE" data-label="{{ $value['label'] }}"  value="{{ $value['label'] }}" @if(old("HOUSEHOLD_MEMBER_HEALTH_BENEFIT_TYPE.$index")) checked @endif/> {{ $value['label'] }} </li>
                                                       @endforeach
                                                    </ul>
