...
<div class="row justify-content-center">
    <div class="col-10">
        ...
        <form action="{{ route('member.household.info.member.step2_update',[request()->store, request()->info, request()->member,  $result->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            {{ method_field('PUT') }}
            <div class="tile">
