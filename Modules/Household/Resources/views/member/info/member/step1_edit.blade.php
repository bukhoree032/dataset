...
<div class="row justify-content-center">
    <div class="col-10">
        ...
        <form action="{{ route('member.household.info.member.step1_update',[request()->store, request()->info, request()->member,  $result->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            {{ method_field('PUT') }}
            <div class="tile">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="my-dropdown dropdown-check-list" tabindex="100" style="width: 100%;">
                                                        ...
                                                        <ul class="items" style="width: 100%;">
                                                            ...
                                                            <li>
                                                                <input type="checkbox" name="HOUSEHOLD_MEMBER_GENERAL_SKILL[{{ $index }}]" class="input-SKILL" data-label="{{ $value['label'] }}" value="{{ $value['label'] }}" @if(isset($result->HOUSEHOLD_MEMBER_GENERAL_SKILL[$index]) && ($result->HOUSEHOLD_MEMBER_GENERAL_SKILL[$index] == $value['label'])) checked @endif/>
                                                                {{ $value['label'] }}
                                                            </li>
                                                            @endforeach
                                                            <textarea placeholder="กรณีอื่น" name="HOUSEHOLD_MEMBER_GENERAL_SKILL_OTHER" style="width: 100%;">{{ $result->HOUSEHOLD_MEMBER_GENERAL_SKILL_OTHER }}</textarea>
                                                        </ul>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="my-dropdown dropdown-check-list" tabindex="100" style="width: 100%;">
                                                                ...
                                                                <ul class="items" style="width: 100%;">
                                                                    ...
                                                                    <li>
                                                                        <input type="checkbox" name="HOUSEHOLD_MEMBER_GENERAL_NATIONAL_LANG[{{ $index }}]" class="input-NATIONAL_LANG" data-label="{{ $value['label'] }}" value="{{ $value['label'] }}" @if(isset($result->HOUSEHOLD_MEMBER_GENERAL_NATIONAL_LANG[$index]) && ($result->HOUSEHOLD_MEMBER_GENERAL_NATIONAL_LANG[$index] == $value['label'])) checked @endif/>
                                                                        {{ $value['label'] }}
                                                                    </li>
                                                                    @endforeach
                                                                    <textarea placeholder="กรณีอื่น" name="HOUSEHOLD_MEMBER_GENERAL_NATIONAL_OTHER" style="width: 100%;">{{ $result->HOUSEHOLD_MEMBER_GENERAL_NATIONAL_OTHER }}</textarea>
                                                                </ul>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="dropdown-check-list" tabindex="100" style="width: 100%;">
                                                                ...
                                                                <ul class="items" style="width: 100%;">
                                                                    ...
                                                                    <li>
                                                                        <input type="checkbox" name="HOUSEHOLD_MEMBER_GENERAL_LOCAL_LANG[{{ $index }}]" class="input-LOCAL_LANG" data-label="{{ $value['label'] }}" value="{{ $value['label'] }}" @if(isset($result->HOUSEHOLD_MEMBER_GENERAL_LOCAL_LANG[$index]) && ($result->HOUSEHOLD_MEMBER_GENERAL_LOCAL_LANG[$index] == $value['label'])) checked @endif/>
                                                                        {{ $value['label'] }}
                                                                    </li>
                                                                    @endforeach
                                                                    <textarea placeholder="กรณีอื่น" name="HOUSEHOLD_MEMBER_GENERAL_LOCAL_OTHER" style="width: 100%;">{{ $result->HOUSEHOLD_MEMBER_GENERAL_LOCAL_OTHER }}</textarea>
                                                                </ul>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="dropdown-check-list" tabindex="100" style="width: 100%;">
                                                        ...
                                                        <ul class="items" style="width: 100%;">
                                                            ...
                                                            <li>
                                                                <input type="radio" name="HOUSEHOLD_MEMBER_GENERAL_STATUS" class="input-STATUS" data-label="{{ $value['label'] }}" value="{{ $value['label'] }}" @if(isset($result->HOUSEHOLD_MEMBER_GENERAL_STATUS) && ($result->HOUSEHOLD_MEMBER_GENERAL_STATUS == $value['label'])) checked @endif/>
                                                                {{ $value['label'] }}
                                                            </li>
                                                            @endforeach
                                                        </ul>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="dropdown-check-list" tabindex="100" style="width: 100%;">
                                                                ...
                                                                <ul class="items" style="width: 100%;">
                                                                    ...
                                                                    <li>
                                                                        <input type="radio" name="HOUSEHOLD_MEMBER_GENERAL_EDU_STATUS" class="input-EDU_STATUS" data-label="{{ $value['label'] }}" value="{{ $value['label'] }}" @if(isset($result->HOUSEHOLD_MEMBER_GENERAL_EDU_STATUS) && ($result->HOUSEHOLD_MEMBER_GENERAL_EDU_STATUS == $value['label'])) checked @endif/>
                                                                        {{ $value['label'] }}
                                                                    </li>
                                                                    @endforeach
                                                                </ul>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="dropdown-check-list" tabindex="100" style="width: 100%;">
                                                                ...
                                                                <ul class="items" style="width: 100%;">
                                                                    ...
                                                                    <li>
                                                                        <input type="radio" name="HOUSEHOLD_MEMBER_GENERAL_EDU_LEVEL" class="input-EDU_LEVEL" data-label="{{ $value['label'] }}" value="{{ $value['label'] }}" @if(isset($result->HOUSEHOLD_MEMBER_GENERAL_EDU_LEVEL) && ($result->HOUSEHOLD_MEMBER_GENERAL_EDU_LEVEL == $value['label'])) checked @endif/>
                                                                        {{ $value['label'] }}
                                                                    </li>
                                                                    @endforeach
                                                                </ul>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="dropdown-check-list" tabindex="100" style="width: 100%;">
                                                        ...
                                                        <ul class="items" style="width: 100%;">
                                                            ...
                                                            <li>
                                                                <input type="radio" name="HOUSEHOLD_MEMBER_GENERAL_READING_LEVEL" class="input-READING_LEVEL" data-label="{{ $value['label'] }}" value="{{ $value['label'] }}" @if(isset($result->HOUSEHOLD_MEMBER_GENERAL_READING_LEVEL) && ($result->HOUSEHOLD_MEMBER_GENERAL_READING_LEVEL == $value['label'])) checked @endif/>
                                                                {{ $value['label'] }}
                                                            </li>
                                                            @endforeach
                                                        </ul>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="dropdown-check-list" tabindex="100" style="width: 100%;">
                                                        ...
                                                        <ul class="items" style="width: 100%;">
                                                            ...
                                                            <li>
                                                                <input type="radio" name="HOUSEHOLD_MEMBER_GENERAL_WRITING_LEVEL" class="input-WRITING_LEVEL" data-label="{{ $value['label'] }}" value="{{ $value['label'] }}" @if(isset($result->HOUSEHOLD_MEMBER_GENERAL_WRITING_LEVEL) && ($result->HOUSEHOLD_MEMBER_GENERAL_WRITING_LEVEL == $value['label'])) checked @endif/>
                                                                {{ $value['label'] }}
                                                            </li>
                                                            @endforeach
                                                        </ul>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="dropdown-check-list" tabindex="100" style="width: 100%;">
                                                        ...
                                                        <ul class="items" style="width: 100%;">
                                                            ...
                                                            <li>
                                                                <input type="radio" name="HOUSEHOLD_MEMBER_GENERAL_CAL_LEVEL" class="input-CAL_LEVEL" data-label="{{ $value['label'] }}" value="{{ $value['label'] }}" @if(isset($result->HOUSEHOLD_MEMBER_GENERAL_CAL_LEVEL) && ($result->HOUSEHOLD_MEMBER_GENERAL_CAL_LEVEL == $value['label'])) checked @endif/>
                                                                {{ $value['label'] }}
                                                            </li>
                                                            @endforeach
                                                        </ul>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="dropdown-check-list" tabindex="100" style="width: 100%;">
                                                        ...
                                                        <ul class="items" style="width: 100%;">
                                                            ...
                                                            <li>
                                                                <input type="radio" name="HOUSEHOLD_MEMBER_GENERAL_RELATIN_HEAD" class="input-RELATIN_HEAD" data-label="{{ $value['label'] }}" value="{{ $value['label'] }}" @if(isset($result->HOUSEHOLD_MEMBER_GENERAL_RELATIN_HEAD) && ($result->HOUSEHOLD_MEMBER_GENERAL_RELATIN_HEAD == $value['label'])) checked @endif/>
                                                                {{ $value['label'] }}
                                                            </li>
                                                            @endforeach
                                                        </ul>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="dropdown-check-list" tabindex="100" style="width: 100%;">
                                                        ...
                                                        <ul class="items" style="width: 100%;">
                                                            ...
                                                            <li>
                                                                <input type="radio" name="HOUSEHOLD_MEMBER_GENERAL_LIVING_STATUS" class="input-LIVING_STATUS" data-label="{{ $value['label'] }}" value="{{ $value['label'] }}" @if(isset($result->HOUSEHOLD_MEMBER_GENERAL_LIVING_STATUS) && ($result->HOUSEHOLD_MEMBER_GENERAL_LIVING_STATUS == $value['label'])) checked @endif/>
                                                                {{ $value['label'] }}
                                                            </li>
                                                            @endforeach
                                                        </ul>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="dropdown-check-list" tabindex="100" style="width: 100%;">
                                                        ...
                                                        <ul class="items" style="width: 100%;"> 
                                                            ...
                                                            @php $row++ @endphp
                                                            <li>
                                                                <input type="radio" name="HOUSEHOLD_MEMBER_GENERAL_OCCUP_ID" class="input-OCCUP_ID" data-label="{{ $value['label'] }}" value="{{ $value['label'] }}" @if(isset($result->HOUSEHOLD_MEMBER_GENERAL_OCCUP_ID) && ($result->HOUSEHOLD_MEMBER_GENERAL_OCCUP_ID == $value['label'])) checked @endif/>
                                                                {{ $value['label'] }}
                                                                    @if ($row == 1 || $row == 13 ||$row == 14 ||$row == 15 ||$row == 16 ||$row == 17 ||$row == 18) 

                                                                    @else
                                                                        <br />
                                                                        <input type="text" name="HOUSEHOLD_MEMBER_GENERAL_OCCUP_DETAILS[{{ $index }}]" value="@if(isset($result->HOUSEHOLD_MEMBER_GENERAL_OCCUP_DETAILS[$index])) {{ $result->HOUSEHOLD_MEMBER_GENERAL_OCCUP_DETAILS[$index] }} @endif" style="width: 60%;" placeholder="กรณี เลือกตัวเลือกข้อที่ {{ $value['id'] }}" />
                                                                    @endif
                                                            </li>
                                                            @endforeach
                                                            <textarea placeholder="กรณีอื่น" name="HOUSEHOLD_MEMBER_GENERAL_OCCUP_ID_OTHER" style="width: 100%;">{{ $result->HOUSEHOLD_MEMBER_GENERAL_OCCUP_ID_OTHER }}</textarea>
                                                        </ul>
                                                        ...
                                                        <ul class="items" style="width: 100%;">
                                                            ...
                                                            <li>
                                                                <input
                                                                    ...
                                                                    value="{{ $value['label'] }}"
                                                                    @if(isset($result->HOUSEHOLD_MEMBER_GENERAL_OCCUP_SUB_ID[$value['id']]) && ($result->HOUSEHOLD_MEMBER_GENERAL_OCCUP_SUB_ID[$value['id']] == $value['id'])) checked @endif
                                                                />
                                                                {{ $value['label'] }}
                                                                @if ($row == 1 || $row == 13 ) 
                                                                ...
                                                                @else
                                                                <br />
                                                                <input type="text" name="HOUSEHOLD_MEMBER_GENERAL_OCCUP_SUB_DETAILS[{{ $value['id'] }}]"  value="{{ $result->HOUSEHOLD_MEMBER_GENERAL_OCCUP_SUB_DETAILS[$value['id']] }}" style="width: 60%;" placeholder="กรณี เลือกตัวเลือกข้อที่ {{ $value['id'] }}" />
                                                                @endif
                                                            </li>
                                                            @endforeach
                                                            <textarea placeholder="กรณีอื่น" name="HOUSEHOLD_MEMBER_GENERAL_OCCUP_SUB_ID_OTHER" style="width: 100%;">{{ $result->HOUSEHOLD_MEMBER_GENERAL_OCCUP_SUB_ID_OTHER }}</textarea>
                                                        </ul>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="dropdown-check-list" tabindex="100" style="width: 100%;">
                                                        ...
                                                        <ul class="items" style="width: 100%;">
                                                            ...
                                                            <li>
                                                                <input type="radio" name="HOUSEHOLD_MEMBER_GENERAL_AREA_OCCUP" class="input-AREA_OCCUP" data-label="{{ $value['label'] }}" value="{{ $value['label'] }}" @if(isset($result->HOUSEHOLD_MEMBER_GENERAL_AREA_OCCUP) && ($result->HOUSEHOLD_MEMBER_GENERAL_AREA_OCCUP == $value['label'])) checked @endif/>
                                                                 {{ $value['label'] }}
                                                            </li>
                                                            @endforeach
