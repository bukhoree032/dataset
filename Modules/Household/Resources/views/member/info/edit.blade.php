                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-row mb-3">
                                    ...
                                    <div class="form-group col-md-5">
                                        ...
                                        <input type="text" class="form-control @error('HOUSEHOLD_INFO_CITIZENNUMBER') is-invalid @enderror" name="HOUSEHOLD_INFO_CITIZENNUMBER" value="{{ $result->HOUSEHOLD_INFO_CITIZENNUMBER }}" placeholder="เลขประจำตัวประชาชน"/>
