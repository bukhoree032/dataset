    ...
    <div class="tile-body">
        ...
        <div class="tab-content" id="pills-tabContent">
            ...
            <div class="tab-pane fade show active" id="pills-econ_3_1" role="tabpanel" aria-labelledby="pills-step_info-tab">
                @if(isset($resultEcon))
                    <div class="bs-example">
                        ...
                        @if(isset($resultEcon))
                            @include('household::member.detail.alldetail.detail_3_1_1')
                        @endif
                    </div>
                    <div class="bs-example">
                        <h3 style="margin-top: -25px;">รายจ่าย</h3>
                        @if(isset($resultEcon))
                            @include('household::member.detail.alldetail.detail_3_1_2')
                        @endif
                    </div>
                @endif
            </div>
            ...
            <div class="tab-pane fade show" id="pills-econ_3_2" role="tabpanel" aria-labelledby="pills-step_info-tab">
                @if(isset($resultEcon))
                    @include('household::member.detail.alldetail.detail_3_2')
                @endif
            </div>
            <!-- ข้อมูลทั่มไป -->
            ...
            <div class="tab-pane fade show" id="pills-econ_3_3" role="tabpanel" aria-labelledby="pills-step_info-tab">
                @if(isset($resultEcon))
                    @include('household::member.detail.alldetail.detail_3_3')
                @endif
            </div>
            <!-- ข้อมูลทั่มไป -->
        </div>
