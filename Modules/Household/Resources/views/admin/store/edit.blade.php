                                        ...
                                        <div class="card mw-100">
                                            <div class="card-body">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        <label>คนที่ 2</label>
                                                        <input type="text" class="form-control" name="STORE_PERSON[1]" value="{{ $result->STORE_PERSON[1] }}" placeholder="คนที่ 2"/>
                                                    </div>
                                                    <div class="col-md-4 mb-3">
                                                        <label>คนที่ 3</label>
                                                        <input type="text" class="form-control" name="STORE_PERSON[2]" value="{{ $result->STORE_PERSON[1] }}" placeholder="คนที่ 3"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
