...
@section('app-content')
    <div class="row justify-content-center">
        <div class="col-10">
            ...
            <form action="{{ route('admin.household.store.create') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="tile">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="STORE_SAVE" value="{{ old('STORE_SAVE') }}" placeholder="ผู้บันทึกข้อมูล"/>
                                    </div>
                                </div>
                                <div class="form-row">
