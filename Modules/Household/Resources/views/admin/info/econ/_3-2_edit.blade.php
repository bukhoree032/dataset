    ...
    <div class="form-group col-md-6">
        ...
        <div class="dropdown-check-list form-control" tabindex="100">
            ...
            <ul class="items">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <input type="checkbox" name="HOUSEHOLD_ECON_HOUSE_LIST[{{ $index }}]" class="input-HOUSE_LIST" data-label="{{ $value['label'] }}" value="{{ $value['label'] }}" @if(isset($result->HOUSEHOLD_ECON_HOUSE_LIST[$index]) && ($result->HOUSEHOLD_ECON_HOUSE_LIST[$index] == $value['id'])) checked @endif/>
                        {{ $value['label'] }}
                    </div>
                    <div class="col-md-6">
                        <input type="text" name="HOUSEHOLD_ECON_HOUSE_NO[{{ $index }}]" placeholder="ขนาด/จำนวน/ปริมาณ" style="width: 100%; margin-top: 5px;" value="{{ $result->HOUSEHOLD_ECON_HOUSE_NO[$index] }}" />
                    </div>
                </div>
                @endforeach
            </ul>
        ...
        <div class="dropdown-check-list form-control" tabindex="100">
            ...
            <ul class="items">
                ...
                <li>
                    <div class="row">
                        <div class="col-md-6">
                            <input type="checkbox" name="HOUSEHOLD_ECON_LAND[{{ $index }}]" class="input-LAND" data-label="{{ $value['label'] }}" value="{{ $value['label'] }}" @if(isset($result->HOUSEHOLD_ECON_LAND[$index]) && ($result->HOUSEHOLD_ECON_LAND[$index] == $value['id'])) checked @endif/>
                            {{ $value['label'] }}
                        </div>
                        <div class="col-md-6">
                            <input type="text" name="HOUSEHOLD_ECON_LAND_SIZE[{{ $index }}]" placeholder="ขนาด/จำนวน/ปริมาณ" value="{{ $result->HOUSEHOLD_ECON_LAND_SIZE[$index] }}" />
                        </div>
                    </div>
                </li>
                @endforeach
        ...
        <div class="dropdown-check-list form-control" tabindex="100">
            ...
            <ul class="items">
                ...
                <li>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <input type="checkbox" name="HOUSEHOLD_ECON_AREA_LIST[{{ $index }}]" value="{{ $value['label'] }}" class="input-AREA_LIST" data-label="{{ $value['label'] }}" @if(isset($result->HOUSEHOLD_ECON_AREA_LIST[$index]) && ($result->HOUSEHOLD_ECON_AREA_LIST[$index] == $value['label'])) checked @endif/> {{ $value['label'] }}
                        </div>
                        <div class="col-md-6">
                            <input type="text" name="HOUSEHOLD_ECON_AREA_NO[{{ $index }}][0]" style="width: 100%" placeholder="ขนาด/จำนวน/ปริมาณ" value="{{ $result->HOUSEHOLD_ECON_AREA_NO[$index][0] }}" />
                        </div>
                    </div>
                    @endif
                    @if ($index==1)
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            - บ้าน <input type="text" name="HOUSEHOLD_ECON_AREA_NO[{{ $index }}][1]" style="width: 100%" placeholder="หลัง/ไร่/งาน/ตารางวา" value="{{ $result->HOUSEHOLD_ECON_AREA_NO[$index][1] }}" />
                        </div>
                        <div class="col-md-6">
                            - ที่ดินทำกิน <input type="text" name="HOUSEHOLD_ECON_AREA_NO[{{ $index }}][2]" style="width: 100%" placeholder="นา/ไร่/สวน/ฟาร์ม" value="{{ $result->HOUSEHOLD_ECON_AREA_NO[$index][2] }}" />
                        </div>
                    </div>
                    @endif
                    @if ($index==2)
                        <div class="row">
                            <div class="col-md-12">
                                <input type="checkbox" name="HOUSEHOLD_ECON_AREA_LIST[{{ $index }}]" value="{{ $value['label'] }}" class="input-AREA_LIST" data-label="{{ $value['label'] }}" @if(isset($result->HOUSEHOLD_ECON_AREA_LIST[$index]) && ($result->HOUSEHOLD_ECON_AREA_LIST[$index] == $value['id'] || $result->HOUSEHOLD_ECON_AREA_LIST[$index] == $value['label'])) checked @endif/> {{ $value['label'] }}
                            </div>
                        </div>
                    @endif
                </li>
            ...
            <ul class="items">
                ...
                <li style="margin-top: 5px;">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <input type="text" name="HOUSEHOLD_ECON_EQUIPMENT_NUM[{{ $index }}]" placeholder="ขนาด/จำนวน/ปริมาณ" value="{{ $result->HOUSEHOLD_ECON_EQUIPMENT_NUM[$index] }}" />
                        </div>
                    </div>
                </li>
                @endforeach
            ...
            <ul class="items">
                ...
                <li style="margin-top: 5px;">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <input type="text" name="HOUSEHOLD_ECON_VEHICLE_NUM[{{ $index }}]" placeholder="ขนาด/จำนวน/ปริมาณ" value="{{ $result->HOUSEHOLD_ECON_VEHICLE_NUM[$index] }}" />
                        </div>
                    </div>
                </li>
                @endforeach
            ...
            <ul class="items">
                ...
                <li style="margin-top: 5px;">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <input type="text" name="HOUSEHOLD_ECON_COM_DEVICE_NUM[{{ $index }}]" placeholder="ขนาด/จำนวน/ปริมาณ" value="{{ $result->HOUSEHOLD_ECON_COM_DEVICE_NUM[$index] }}" />
                        </div>
                    </div>
                </li>
                @endforeach
            ...
            <ul class="items">
                ...
                <li style="margin-top: 5px;">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <input type="text" name="HOUSEHOLD_ECON_PET_NUM[{{ $index }}]" placeholder="ขนาด/จำนวน/ปริมาณ" value="{{ $result->HOUSEHOLD_ECON_PET_NUM[$index] }}" />
                        </div>
                    </div>
                </li>
                @endforeach
