<div class="row">
    ...
    <div class="col-md-4">
        <label class="red-start">จำนวนเงิน</label> <input name="DEPT_AMOUNT" class="form-control @error('HOUSEHOLD_ECON_EXP_SUM[1]') is-invalid @enderror" type="text" placeholder="ตัวอย่าง 50000" />
