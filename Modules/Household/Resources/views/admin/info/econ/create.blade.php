...
<div class="row justify-content-center">
    <div class="col-sm-12 col-md-8">
        ...
        <form action="{{ route('admin.household.info.econ.store',[$store_id, $info_id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="tile">
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-home3" role="tabpanel" aria-labelledby="pills-home3-tab">
                                    <div class="bs-example">
                                        <p>รายรับ</p>
                                        @include('household::admin.info.econ._3-1-1')
                                    </div>
                                    <div class="bs-example">
                                        <p>รายจ่าย</p>
                                        @include('household::admin.info.econ._3-1-2')
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="pills-profile3" role="tabpanel" aria-labelledby="pills-profile3-tab">
                                    <div class="bs-example">
                                        ...
                                        @include('household::admin.info.econ._3-2')
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="pills-contact3" role="tabpanel" aria-labelledby="pills-contact3-tab">
                                    <div class="bs-example">
                                        ...
                                        @include('household::admin.info.econ._3-3')
                                    </div>
