...
@section('app-content')
    <div class="row justify-content-center" ng-controller="infoController">
        <div class="col-10">
            ...
            <form action="{{ route('admin.household.info.update',[request()->store,  $result->id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                {{ method_field('PUT') }}
                <div class="tile">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-row mb-3">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control @error('HOUSEHOLD_INFO_CITIZENNUMBER') is-invalid @enderror" name="HOUSEHOLD_INFO_CITIZENNUMBER" value="{{ $result->HOUSEHOLD_INFO_CITIZENNUMBER }}" placeholder="เลขประจำตัวประชาชน(เจ้าบ้าน)"/>
