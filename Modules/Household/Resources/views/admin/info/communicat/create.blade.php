...
<div class="row justify-content-center">
    <div class="col-sm-12 col-md-8">
        ...
        <form action="{{ route('admin.household.info.communicat.store',[$store_id, $info_id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="tile">
                ...
                <div class="tile-body">
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <textarea name="SUGGESTION" class="form-control" rows="10" placeholder="ข้อเสนอแนะ">{{ old('SUGGESTION') }}</textarea>
                        </div>
                    </div>
                </div>
