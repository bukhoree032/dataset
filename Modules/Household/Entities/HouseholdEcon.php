...
class HouseholdEcon extends Model
{
    ...
    protected $fillable = [
        'HOUSEHOLD_ECON_GENERAL',
        'HOUSEHOLD_ECON_AGRI',
        'HOUSEHOLD_ECON_LIVESTOCK',
        'HOUSEHOLD_ECON_FISHING',
        'HOUSEHOLD_ECON_OCCU_OTHER',
        'HOUSEHOLD_ECON_CHILD',
        'HOUSEHOLD_ECON_WELFARE',
        'HOUSEHOLD_ECON_OTHER_REVENUE',
        'HOUSEHOLD_ECON_NOTE_REVENUE',

        'HOUSEHOLD_ECON_FOOD',
        'HOUSEHOLD_ECON_WATER',
        'HOUSEHOLD_ECON_ELECTRICITY',
        'HOUSEHOLD_ECON_TEL',
        'HOUSEHOLD_ECON_INTERNET',
        'HOUSEHOLD_ECON_STUDY',
        'HOUSEHOLD_ECON_NURSE',
        'HOUSEHOLD_ECON_INSURANCE',
        'HOUSEHOLD_ECON_SOCIETY',
        'HOUSEHOLD_ECON_TRAVEL',
        'HOUSEHOLD_ECON_RISK',
        'HOUSEHOLD_ECON_ALCOHOL',
        'HOUSEHOLD_ECON_DEBT',
        'HOUSEHOLD_ECON_OTHER_EXPENSES',
        'HOUSEHOLD_ECON_NOTE_EXPENSES',
