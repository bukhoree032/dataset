...
Route::name('admin.')->group(function () {
    Route::name('household.')->group(function () {
        Route::prefix('household')->group(function () {
            ...
            Route::get('/show/', 'HouseholdController@show')->name('show');
            Route::put('/show/', 'HouseholdController@search')->name('show.search');
            Route::post('/show/AMPHURE/', 'HouseholdController@AMPHURE')->name('AMPHURE');
            Route::post('/show/DISTRICT/', 'HouseholdController@DISTRICT')->name('DISTRICT');
